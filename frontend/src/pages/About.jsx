...
const About = () => {
  ...
  ><div className="glass-card p-8"><h3 className="mb-4 text-2xl font-semibold text-foreground">
    {content.headline || "Backend & AI Developer"}
  </h3><div className="space-y-4 text-muted-foreground"><p>
    {content.description || "Passionate about software development, I specialize in building robust backend systems and implementing AI solutions that solve real-world problems."}
  </p><p>
          {content.mission || "My journey began with a passion for algorithms and data structures, which evolved into expertise in distributed systems, microservices architecture, and machine learning."}
        </p><p>
          {content.education || "I believe in writing clean, maintainable code and following best practices in software engineering. When I'm not coding, you'll find me exploring new technologies or contributing to open-source projects."}
        ...
        ><div className="glass-card p-8"><h3 className="mb-6 text-2xl font-semibold text-foreground">
          ...
          { label: "Focus", value: "AI Enthusiast" },
          { label: "Coffee Cups", value: "\u221E" },
          { label: "Status", value: content.yearsOfExperience || "Open for Work" }
