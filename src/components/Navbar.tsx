    ...
    >
      <div className="container mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="hidden items-center gap-1 md:flex">
          ...
          <Link
            to="/admin"
            className="ml-4 rounded-lg border border-primary/30 px-4 py-2 text-sm font-medium text-primary transition-all hover:bg-primary/10"
          >
            Admin
          </Link>
        </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="container mx-auto flex flex-col gap-2 px-6 py-4">
              ...
              <Link
                to="/admin"
                className="mt-2 rounded-lg border border-primary/30 px-4 py-3 text-center text-primary transition-all hover:bg-primary/10"
              >
                Admin Panel
              </Link>
            </div>
